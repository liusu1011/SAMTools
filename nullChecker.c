...
Z3_ast Idle_tok0 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "Idle_tok0"), DT0SORT);
Z3_ast Idle_tok0_and[1];
Idle_tok0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], Idle_tok0), mk_int(ctx, 1));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 1, Idle_tok0_and));
Z3_ast ini_set1 = Z3_mk_set_add(ctx, ini_set0, Idle_tok0);
Z3_ast Idle_tok1 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "Idle_tok1"), DT0SORT);
Z3_ast Idle_tok1_and[1];
Idle_tok1_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], Idle_tok1), mk_int(ctx, 2));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 1, Idle_tok1_and));
Z3_ast ini_set2 = Z3_mk_set_add(ctx, ini_set1, Idle_tok1);
...
Z3_ast ini_set5 = Z3_mk_empty_set(ctx, DT1SORT);
Z3_ast Monitor_tok0 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "Monitor_tok0"), DT1SORT);
Z3_ast Monitor_tok0_and[2];
Monitor_tok0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT1_proj_decls[0], Monitor_tok0), mk_int(ctx, 1));
Monitor_tok0_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT1_proj_decls[1], Monitor_tok0), mk_int(ctx, 0));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 2, Monitor_tok0_and));
Z3_ast ini_set6 = Z3_mk_set_add(ctx, ini_set5, Monitor_tok0);
Z3_ast Monitor_tok1 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "Monitor_tok1"), DT1SORT);
Z3_ast Monitor_tok1_and[2];
Monitor_tok1_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT1_proj_decls[0], Monitor_tok1), mk_int(ctx, 2));
Monitor_tok1_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT1_proj_decls[1], Monitor_tok1), mk_int(ctx, 0));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 2, Monitor_tok1_and));
Z3_ast ini_set7 = Z3_mk_set_add(ctx, ini_set6, Monitor_tok1);
...
property_or[0] = mk_and(ctx, mk_and(ctx, Z3_mk_true(ctx), Z3_mk_set_member(ctx, PS0Tok0, mk_unary_app(ctx, proj_decls[2], S0))), Z3_mk_set_member(ctx, PS0Tok1, mk_unary_app(ctx, proj_decls[2], S0)));
...
property_or[1] = mk_and(ctx, mk_and(ctx, Z3_mk_true(ctx), Z3_mk_set_member(ctx, PS1Tok0, mk_unary_app(ctx, proj_decls[2], S1))), Z3_mk_set_member(ctx, PS1Tok1, mk_unary_app(ctx, proj_decls[2], S1)));
...
property_or[2] = mk_and(ctx, mk_and(ctx, Z3_mk_true(ctx), Z3_mk_set_member(ctx, PS2Tok0, mk_unary_app(ctx, proj_decls[2], S2))), Z3_mk_set_member(ctx, PS2Tok1, mk_unary_app(ctx, proj_decls[2], S2)));
...
property_or[3] = mk_and(ctx, mk_and(ctx, Z3_mk_true(ctx), Z3_mk_set_member(ctx, PS3Tok0, mk_unary_app(ctx, proj_decls[2], S3))), Z3_mk_set_member(ctx, PS3Tok1, mk_unary_app(ctx, proj_decls[2], S3)));
Z3_assert_cnstr(ctx, Z3_mk_or(ctx, 4, property_or));
