...
S0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[0], S0), ini_set0);
Z3_ast ini_set1 = Z3_mk_empty_set(ctx, DT0SORT);
S0_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[1], S0), ini_set1);
Z3_ast ini_set2 = Z3_mk_empty_set(ctx, DT0SORT);
S0_and[2] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[2], S0), ini_set2);
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 3, S0_and));
//transitions
Z3_ast transitions_and[2];

Z3_ast S0_trans_or[3];
Z3_ast S0_T0_P0_x = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S0x"), DT0SORT);
Z3_ast S0_T0_P1_y = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S0y"), DT0SORT);
Z3_ast t0S0_cond_and[2];
t0S0_cond_and[0] = Z3_mk_set_member(ctx, S0_T0_P0_x, mk_unary_app(ctx, proj_decls[0], S0));
t0S0_cond_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S0_T0_P1_y), mk_add(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S0_T0_P0_x), mk_int(ctx, 1)));
Z3_ast t0S0_cond = Z3_mk_and(ctx, 2, t0S0_cond_and);
Z3_ast t0S0_true_and[3];
t0S0_true_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[0], S1), Z3_mk_set_del(ctx, mk_unary_app(ctx, proj_decls[0], S0), S0_T0_P0_x));
t0S0_true_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[1], S1), Z3_mk_set_add(ctx, mk_unary_app(ctx, proj_decls[1], S0), S0_T0_P1_y));
...
S0_trans_or[0] = t0S0;
Z3_ast S0_T1_P1_z = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S0z"), DT0SORT);
Z3_ast S0_T1_P2_p = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S0p"), DT0SORT);
Z3_ast t1S0_cond_and[2];
t1S0_cond_and[0] = Z3_mk_set_member(ctx, S0_T1_P1_z, mk_unary_app(ctx, proj_decls[1], S0));
t1S0_cond_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S0_T1_P2_p), mk_add(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S0_T1_P1_z), mk_int(ctx, 1)));
Z3_ast t1S0_cond = Z3_mk_and(ctx, 2, t1S0_cond_and);
Z3_ast t1S0_true_and[3];
t1S0_true_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[1], S1), Z3_mk_set_del(ctx, mk_unary_app(ctx, proj_decls[1], S0), S0_T1_P1_z));
t1S0_true_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[2], S1), Z3_mk_set_add(ctx, mk_unary_app(ctx, proj_decls[2], S0), S0_T1_P2_p));
...
Z3_ast S1_T0_P0_x = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S1x"), DT0SORT);
Z3_ast S1_T0_P1_y = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S1y"), DT0SORT);
Z3_ast t0S1_cond_and[2];
t0S1_cond_and[0] = Z3_mk_set_member(ctx, S1_T0_P0_x, mk_unary_app(ctx, proj_decls[0], S1));
t0S1_cond_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S1_T0_P1_y), mk_add(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S1_T0_P0_x), mk_int(ctx, 1)));
Z3_ast t0S1_cond = Z3_mk_and(ctx, 2, t0S1_cond_and);
Z3_ast t0S1_true_and[3];
t0S1_true_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[0], S2), Z3_mk_set_del(ctx, mk_unary_app(ctx, proj_decls[0], S1), S1_T0_P0_x));
t0S1_true_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[1], S2), Z3_mk_set_add(ctx, mk_unary_app(ctx, proj_decls[1], S1), S1_T0_P1_y));
...
S1_trans_or[0] = t0S1;
Z3_ast S1_T1_P1_z = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S1z"), DT0SORT);
Z3_ast S1_T1_P2_p = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "S1p"), DT0SORT);
Z3_ast t1S1_cond_and[2];
t1S1_cond_and[0] = Z3_mk_set_member(ctx, S1_T1_P1_z, mk_unary_app(ctx, proj_decls[1], S1));
t1S1_cond_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S1_T1_P2_p), mk_add(ctx, mk_unary_app(ctx, DT0_proj_decls[0], S1_T1_P1_z), mk_int(ctx, 1)));
Z3_ast t1S1_cond = Z3_mk_and(ctx, 2, t1S1_cond_and);
Z3_ast t1S1_true_and[3];
t1S1_true_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[1], S2), Z3_mk_set_del(ctx, mk_unary_app(ctx, proj_decls[1], S1), S1_T1_P1_z));
t1S1_true_and[1] = Z3_mk_eq(ctx, mk_unary_app(ctx, proj_decls[2], S2), Z3_mk_set_add(ctx, mk_unary_app(ctx, proj_decls[2], S1), S1_T1_P2_p));
...
Z3_ast PS0Tok0 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "PS0_P2_tok0"), DT0SORT);
Z3_ast S0P2_tok_0_and[1];
S0P2_tok_0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], PS0Tok0), mk_int(ctx, 6));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 1, S0P2_tok_0_and));
property_or[0] = mk_and(ctx, Z3_mk_true(ctx), Z3_mk_not(ctx, Z3_mk_set_member(ctx, PS0Tok0, mk_unary_app(ctx, proj_decls[2], S0))));
Z3_ast PS1Tok0 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "PS1_P2_tok0"), DT0SORT);
Z3_ast S1P2_tok_0_and[1];
S1P2_tok_0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], PS1Tok0), mk_int(ctx, 6));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 1, S1P2_tok_0_and));
property_or[1] = mk_and(ctx, Z3_mk_true(ctx), Z3_mk_not(ctx, Z3_mk_set_member(ctx, PS1Tok0, mk_unary_app(ctx, proj_decls[2], S1))));
Z3_ast PS2Tok0 = Z3_mk_const(ctx, Z3_mk_string_symbol(ctx, "PS2_P2_tok0"), DT0SORT);
Z3_ast S2P2_tok_0_and[1];
S2P2_tok_0_and[0] = Z3_mk_eq(ctx, mk_unary_app(ctx, DT0_proj_decls[0], PS2Tok0), mk_int(ctx, 6));
Z3_assert_cnstr(ctx, Z3_mk_and(ctx, 1, S2P2_tok_0_and));
property_or[2] = mk_and(ctx, Z3_mk_true(ctx), Z3_mk_not(ctx, Z3_mk_set_member(ctx, PS2Tok0, mk_unary_app(ctx, proj_decls[2], S2))));
